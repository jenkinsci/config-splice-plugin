...
> Never place a secret in `value:`. Literal step arguments may be persisted and displayed by Pipeline metadata and visualization features. Use `credentialsId:` for secrets.
